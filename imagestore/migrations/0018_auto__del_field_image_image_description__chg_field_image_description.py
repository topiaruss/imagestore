...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'imagestore_image', 'description', self.gf('django.db.models.fields.TextField')(default='', max_length=100))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Image.description'
        db.alter_column(u'imagestore_image', 'description', self.gf('django.db.models.fields.TextField')(null=True))
