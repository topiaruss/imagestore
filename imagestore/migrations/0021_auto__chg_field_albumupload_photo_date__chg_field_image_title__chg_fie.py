...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'AlbumUpload.photo_date'
        db.alter_column(u'imagestore_albumupload', 'photo_date', self.gf('django.db.models.fields.DateTimeField')(null=True))
        ...
        # Changing field 'Image.photographers_name'
        db.alter_column(u'imagestore_image', 'photographers_name', self.gf('django.db.models.fields.CharField')(default='', max_length=100))

    def backwards(self, orm):

        # Changing field 'AlbumUpload.photo_date'
        db.alter_column(u'imagestore_albumupload', 'photo_date', self.gf('django.db.models.fields.DateField')(null=True))

        # Changing field 'Image.title'
        db.alter_column(u'imagestore_image', 'title', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

        # Changing field 'Image.photographers_name'
        db.alter_column(u'imagestore_image', 'photographers_name', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))
    ...
    models = {
        ...
        'imagestore.albumupload': {
            ...
            'photo_date': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
        ...
        'imagestore.image': {
            ...
            'event_name': ('django.db.models.fields.CharField', [], {'max_length': '100', 'blank': 'True'}),
            'exif': ('django_pgjson.fields.JsonField', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'video_url': ('django.db.models.fields.URLField', [], {'default': "''", 'max_length': '200', 'blank': 'True'})
        }
    }
