...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Image.photo_date'
        db.alter_column(u'imagestore_image', 'photo_date', self.gf('django.db.models.fields.DateTimeField')(null=True))

    def backwards(self, orm):

        # Changing field 'Image.photo_date'
        db.alter_column(u'imagestore_image', 'photo_date', self.gf('django.db.models.fields.DateField')(null=True))
